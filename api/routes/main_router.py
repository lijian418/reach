...
from routes.endpoints.alert_route import router as alert_routes_router
...
main_router.include_router(alert_routes_router, prefix="/alert-routes", tags=["alert-routes"])
